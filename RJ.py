# Decompile by Mardis (Tools By RaFi Hasan)
...
\033[1;32m[-] AUTHOR    :\033[1;32m RJ RaFi
\033[1;32m[-] GITHUB    :\033[1;32m Monster404
...
rp= 'RaFi'
x = 'Monster'
if 'Rafi'==user and 'Monster'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK GROUP ")
	os.system('xdg-open https://facebook.com/groups/822909896019695/ ')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://www.facebook.com/tolibestfrind")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH KING-14 ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥KING-14🔥  "+w+tim)
